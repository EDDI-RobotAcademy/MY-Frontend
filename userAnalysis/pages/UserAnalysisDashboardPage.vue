...
const filter = ref('')
const answers = ref([])
const user_analysis_Id = ref(null)
...
const loadFilteredAnswers = async () => {
  ...
  if (filter.value === 'user_analysis') {
    ...
    payload.user_analysis_Id = ''
    payload.question_Id = ''
  } else if (filter.value === 'user_analysis and account') {
    payload.question_Id = ''
  }
